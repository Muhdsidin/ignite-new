...
const ContactForm = () => {
  ...
  return (
    <form
      ...
      className="w-[90%] mt-20 max-w-2xl mx-auto p-6 rounded-md shadow-md space-y-4 flex flex-col justify-center items-center relative " // Ensure form is not clipped
    >
      <motion.div
      ...
      <Button
        size="sm"
        cursor="pointer"
        className="w-fit z-50" // Ensure button is above other elements
        onClick={sendMail}
      >
        Contact Support
      </Button>
